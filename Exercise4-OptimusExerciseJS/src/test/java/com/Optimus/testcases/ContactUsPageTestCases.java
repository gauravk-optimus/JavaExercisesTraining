...
public class ContactUsPageTestCases extends BaseClass {
	...
	/**
	 * Verify entering, changing, deleting text using JS
	 */

	@Test(description = "User is able enter, change, delete text using JS", priority = 1)
	public void contact(ITestContext context) {
		logger.info("Doing JS operations");
